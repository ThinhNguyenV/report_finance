...
plt.plot(df_combined['Date'], df_combined['Doanh thu'], label='Doanh thu (MKT)')
plt.plot(df_combined['Date'], df_combined['Chi phí Marketing'], label='Chi phí Marketing')
plt.title('Xu hướng Tài chính Q3 2020')
plt.xlabel('Ngày')
plt.ylabel('Số tiền')
plt.legend()
plt.grid(True)
...
print("Dữ liệu đã được lưu vào daily_finance_summary.csv và biểu đồ vào finance_trend.png")
